...
public class Ontologia {
     ...
     */
    public static OntModel getOntologiaDeDominio(File file) {
...
//            model.read(in, "");
     ...
     */
    public static List<OntClass> obtemClasses(OntModel od) {
     ...
     */
    public static List<String> obtemPropriedadesDoObjeto(OntModel od) {
     ...
     */
    public static List<DatatypeProperty> obtemTipoDeDados(OntModel od) {
...
//            System.out.println("[***Data] "+dtp.getLocalName());
     ...
     */
    public static Map<String, String> obtemPrefixosDaOntologiaDominio(OntModel od){
